...
<head>
    ...
    <link rel="stylesheet" href="style/pages-style/create-course-page.css">
    ...
    <div class="content">
        <div class="centered">
            <div class="create-course-container">
                <h4 class="main-header">СОЗДАТЬ КУРС</h4>

                <form class="creation-form" action="controller" method="POST">
                	<input type="hidden" name="command" values="create_course"/>;
                    <label for="name">Название курса (3-30 символов):</label>
                    <input type="text" name="name" id="name" pattern="^\.{3,30}$" required>

                    <label for="description">Описание курса: (не более двухсот символов)</label>
                    <textarea name="description" id="description" cols="20" rows="10" maxlength="200"></textarea>
