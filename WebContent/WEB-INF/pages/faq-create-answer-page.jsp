...
<head>
    ...
    <link rel="stylesheet" href="style/pages-style/faq-create-answer-page.css">
...
<div class="row sticky-top main-menu">
    ...
    <div class="col-10">
            ...
            <button onclick= "/controller?command=faq&method=POST&method=POST">FAQ</button>
        </div>
</div>
        ...
        <div class="faq-container">
            <div class="reply-form">
                ...
                <form action="controller" method=POST>
                    <textarea name="answer" cols="100" rows="10" required></textarea>
					<input type = "hidden" name="command" values = "answer_question"/>
